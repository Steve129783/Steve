...
# 4. 冻结并屏蔽第一层指定通道
# =========================
def mask_and_freeze_conv1(model, desired):
...
# =========================
# 5. 主流程：全数据 PC1 vs Brightness 并线性拟合 + 限流 + 交互高亮
# =========================
def extract_and_plot_all():
    ...
    ax.set_xlabel("PC1"); ax.set_ylabel("Normalized Contrast")
