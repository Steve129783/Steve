...
if __name__ == '__main__':
    ...
    group_name = '17'
    template_json_path  = Path(rf"D:\Study\Postgraduate\S2\Project\Code\Resource\mainbody label\{file_name}\{group_name}\crop_Components_17view.transformed308.json") # Mask position
    ...
    images_dir          = Path(rf"D:\Study\Postgraduate\S2\Project\Code\Resource\Original\{file_name}\{group_name}") # image file
    output_dir          = Path(rf"E:\Project_SNV\0S\1_Full_Raw_MB\{group_name}") # main body file
