...
def get_transforms():
    return A.Compose([
        ...
        A.GaussNoise(p=0.2),
        A.Resize(height=340, width=414),
        A.Normalize(mean=(0.5,0.5,0.5), std=(0.5,0.5,0.5)),
        ToTensorV2()
    ])

# ---- Prepare DataLoader ----
image_paths = sorted(glob.glob(r'D:\Study\Postgraduate\S2\Project\Code\Resource\Original\17_18_19_20\17\*.tif'))
json_paths  = sorted(glob.glob(r'E:\Project_SNV\0S\1_Full_Raw_MB\17\*.json'))
