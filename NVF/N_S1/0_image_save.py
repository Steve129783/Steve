...
# 输入 TIFF 路径
tif_path  = r'E:\Project_CNN\CT_DATA\OneDrive_1_2025-6-30\1_CorrectEnergyCropped.tif'
# 保存裁剪后整张图的目录
full_dir  = r'E:\Project_CNN\1_full\image\correct'
# 保存切分 patch 的目录
patch_dir = r'E:\Project_CNN\0_image\correct'
